...
RSpec.describe FightsController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new fight" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the fight" do
        fight = Fight.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the fight" do
        fight = Fight.create! valid_attributes
